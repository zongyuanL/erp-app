package cn.alex.demosplit.servicelog.config.oauth;

import cn.alex.demosplit.servicelog.config.error.MssWebResponseExceptionTranslator;
...
//                .withClient("haha") // client_id   android
//                .scopes("read")
